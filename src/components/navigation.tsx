...
export const Navigation: FC = () => {
  ...
  const tabs: Record<string, MenuItem> = {
    "/": {
      ...
      activeIcon: (
        <img src={homeIcon} alt="Home" className={"nav-primary-color"} />
      ),
    },
    ...
    "/search": {
      ...
      activeIcon: (
        <img src={searchIcon} alt="Search" className={"nav-primary-color"} />
      ),
    },
    "/cart": {
      label: "Giỏ hàng",
    ...
    "/openChat": {
      ...
      activeIcon: (
        <img src={chatOaIcon} alt="Chat OA" className={"nav-primary-color"} />
      ),
    },
    "/profile": {
      label: "Cá nhân",
