...
import { bankState, cartState, totalPriceState } from "state";
import { addressSelectedState, noteState, selectedPaymentMethod } from "pages/cart/state";
  ...
  return (
    <Page className="flex flex-col">
      <div className="flex flex-1 flex-col justify-center align-middle p-10">
         {paymentMethod?.value ==='chuyen_khoan'?  <img src={qrImage} /> : <img src={Success}/>}
